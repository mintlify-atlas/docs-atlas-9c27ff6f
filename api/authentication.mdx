...
description: Learn how ZapDev uses Clerk JWT tokens to authenticate API requests in Convex
---
...
- [API Overview](/api/introduction) - Learn about the Convex API architecture
